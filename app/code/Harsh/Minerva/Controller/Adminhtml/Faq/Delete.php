...
namespace Harsh\Minerva\Controller\Adminhtml\Faq;
use Harsh\Minerva\Model\Faq;
use Harsh\Minerva\Model\FaqFactory;
use Harsh\Minerva\Model\ResourceModel\Faq as FaqResource;
...
{
    const ADMIN_RESOURCE = 'Harsh_Minerva::faq_delete';
    /** @var FaqFactory */
